...
class EmbeddedKeycloakConfig {
    ...
    protected com.example.keycloakmodule.config.spi.SimplePlatformProvider springBootPlatform() {
        return (com.example.keycloakmodule.config.spi.SimplePlatformProvider) Platform.getPlatform();
    }
}
